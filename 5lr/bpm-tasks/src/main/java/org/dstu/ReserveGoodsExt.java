    ...
    public static void main(String[] args) {
        ...
        client.subscribe("reserve-goods")
                ...
                .handler((externalTask, externalTaskService) -> {
                    String supermarketModel = (String) externalTask.getVariable("supermarketModel");
                    ...
                    LOGGER.info("Trying reserves " +
                            "supermarket model = " + supermarketModel + " quantity = " + quantityReserve);

                    URL url = getWSDLURL("http://localhost:8082/Reservation?wsdl");
                    ReservationClient resClient = new ReservationClient();
                    UserReserve userReserve = resClient.processCallback(url, supermarketModel, quantityReserve);
